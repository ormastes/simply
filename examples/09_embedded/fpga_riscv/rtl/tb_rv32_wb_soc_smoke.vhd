...
architecture sim of tb_rv32_wb_soc_smoke is
  ...
  constant MARKER : string := "FPGA-RV32";
...
begin
  ...
  begin
    ...
    assert byte_seen = '1' report "RV32_UART_BYTE_MISSING" severity failure;
    assert marker_seen = '1' report "RV32_UART_MARKER_MISSING" severity failure;
    report "RV32_UART_TX_ACTIVITY_SEEN" severity note;
    report "RV32_UART_BYTE_SEEN" severity note;
    report "RV32_UART_MARKER_SEEN" severity note;
    wait;
  end process;
  ...
  begin
    ...
    loop
      ...
      byte_seen <= '1';
      report "RV32_UART_BYTE_VALUE=" & integer'image(byte_value) severity note;
